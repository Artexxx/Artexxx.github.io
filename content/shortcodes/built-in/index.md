...
```markdown
{{</* figure src="featured-image.webp" title="HUGO (figure)" */>}}
```
...
```markdown
{{</* qr text="https://github.com/Artexxx" */>}}
```
...
```markdown
- [Built-in Shortcodes]({{%/* ref "/shortcodes/built-in" */%}})
- [Extended Shortcodes]({{%/* ref "/shortcodes/extended" */%}})
```
...
```html
<ul>
  <li><a href="http://example.org/shortcodes/built-in">Built-in Shortcodes</a></li>
  <li><a href="http://example.org/shortcodes/extended">Extended Shortcodes</a></li>
</ul>
```
...
```markdown
- [Built-in Shortcodes]({{%/* relref "/shortcodes/built-in" */%}})
- [Extended Shortcodes]({{%/* relref "/shortcodes/extended" */%}})
```
...
```html
<ul>
  <li><a href="/shortcodes/built-in">Built-in Shortcodes</a></li>
  <li><a href="/shortcodes/extended">Extended Shortcodes</a></li>
</ul>
```
